...
/// </summary>
public partial class SqLiteAppDataProvider : BaseDataProvider, IAppDataProvider
{
   #region Consts
   ...
   /// <returns>ContactName of a foreign key</returns>
   ...
   /// <returns>ContactName of an index</returns>
   ...
   public string BuildConnectionString(IAppConnectionStringInfo nopConnectionString)
   {
