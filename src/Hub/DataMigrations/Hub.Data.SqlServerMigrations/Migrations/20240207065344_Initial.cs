      ...
      protected override void Up(MigrationBuilder migrationBuilder)
      {
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                SubjectName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                Rate = table.Column<decimal>(type: "decimal(12,5)", precision: 12, scale: 5, nullable: false),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                IsRequired = table.Column<bool>(type: "bit", nullable: false),
                RequiredMessage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                DisplayDuringRegistration = table.Column<bool>(type: "bit", nullable: false),
                DisplayOnUserInfoPage = table.Column<bool>(type: "bit", nullable: false),
                DisplayOrder = table.Column<int>(type: "int", nullable: false)
             },
             constraints: table =>
             {
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                FullMessage = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
                IpAddress = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                EntityId = table.Column<long>(type: "bigint", nullable: true),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                SystemKeyword = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                Ratio = table.Column<decimal>(type: "decimal(12,5)", precision: 12, scale: 5, nullable: false),
                DisplayOrder = table.Column<int>(type: "int", nullable: false)
             },
             constraints: table =>
             {
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                Id = table.Column<long>(type: "bigint", nullable: false)
                     .Annotation("SqlServer:Identity", "1, 1"),
                Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                BccEmailAddresses = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                LastEnabledUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                Enabled = table.Column<bool>(type: "bit", nullable: false),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                Id = table.Column<long>(type: "bigint", nullable: false)
                     .Annotation("SqlServer:Identity", "1, 1"),
                Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                Value = table.Column<string>(type: "nvarchar(max)", maxLength: 6000, nullable: false)
             },
             constraints: table =>
             {
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                DeviceCountLimit = table.Column<int>(type: "int", nullable: false),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                ResourceValue = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false)
             },
             constraints: table =>
             {
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                DisplayOrder = table.Column<int>(type: "int", nullable: false),
                AccessibleWhenPlatformClosed = table.Column<bool>(type: "bit", nullable: false),
         ...
         migrationBuilder.CreateTable(
             ...
             constraints: table =>
             {
                ...
                table.ForeignKey(
                       name: "FK_PermissionRecordUserRoles_PermissionRecords_PermissionRecordId",
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                ShowOnMain = table.Column<bool>(type: "bit", nullable: false),
                LastIpAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                CountDataRows = table.Column<int>(type: "int", nullable: false),
                DataSendingDelay = table.Column<int>(type: "int", nullable: false),
                DataflowReconnectDelay = table.Column<int>(type: "int", nullable: false),
                DataPacketSize = table.Column<int>(type: "int", nullable: false),
                ClearDataDelay = table.Column<int>(type: "int", nullable: false),
                LastActivityOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                CreatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                UpdatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                FailedLoginAttempts = table.Column<int>(type: "int", nullable: false),
                CannotLoginUntilDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                UserId = table.Column<long>(type: "bigint", nullable: false),
                FileName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                TaskDateTimeUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                ReadyDateTimeUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                DelayUntilUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                Adjustment = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                CreatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                UpdatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                UserId = table.Column<long>(type: "bigint", nullable: false)
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                CreatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                UpdatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                ForumTopicType = table.Column<int>(type: "int", nullable: false)
             },
             constraints: table =>
             {
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                ShowInCommonLog = table.Column<bool>(type: "bit", nullable: false),
                CreatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                UpdatedOnUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                IsDeleted = table.Column<bool>(type: "bit", nullable: false)
             },
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                ...
                Metadata = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
         ...
         migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                Id = table.Column<long>(type: "bigint", nullable: false)
                     .Annotation("SqlServer:Identity", "1, 1"),
                Extinf = table.Column<double>(type: "float", nullable: false),
                InboundName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                Guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                IpcamId = table.Column<long>(type: "bigint", nullable: false),
                OnCreatedUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                OnReceivedUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
