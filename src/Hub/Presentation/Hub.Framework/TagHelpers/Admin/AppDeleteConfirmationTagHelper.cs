...
{
   /// <summary>
   /// "app-delete-confirmation" tag helper
   /// </summary>
   [HtmlTargetElement("app-delete-confirmation", Attributes = MODEL_ID_ATTRIBUTE_NAME + "," + BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
   public class AppDeleteConfirmationTagHelper : TagHelper
   {
      #region Constants
      ...
      public AppDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
      {
         Generator = generator;
