...
namespace Hub.Web.Framework.TagHelpers.Admin
{
   ...
   /// "app-tabs" tag helper
   /// </summary>
   [HtmlTargetElement("app-tabs", Attributes = ID_ATTRIBUTE_NAME)]
   public class AppTabsTagHelper : TagHelper
   {
      ...
      /// <summary>
      /// ContactName of the tab which should be selected
      /// </summary>
   ...
   /// "app-tab" tag helper
   /// </summary>
   [HtmlTargetElement("app-tab", ParentTag = "app-tabs", Attributes = NAME_ATTRIBUTE_NAME)]
