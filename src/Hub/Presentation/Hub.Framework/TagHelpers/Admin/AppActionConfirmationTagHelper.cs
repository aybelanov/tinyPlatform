...
{
   /// <summary>
   /// "app-action-confirmation" tag helper
   /// </summary>
   [HtmlTargetElement("app-action-confirmation", Attributes = BUTTON_ID_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
   public class AppActionConfirmationTagHelper : TagHelper
   {
      #region Constants
