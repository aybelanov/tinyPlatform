...
{
   /// <summary>
   /// "app-label" tag helper
   /// </summary>
   [HtmlTargetElement("app-label", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
   public class AppLabelTagHelper : TagHelper
   {
      ...
      public AppLabelTagHelper(IHtmlGenerator generator, ILocalizationService localizationService, IWorkContext workContext)
      {
         Generator = generator;
      ...
      public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
      {
         ...
         if (tagBuilder != null)
         {
            ...
            //add hint
            if (DisplayHint && For.Metadata.AdditionalValues.TryGetValue("AppResourceDisplayNameAttribute", out var value)
                && value is AppResourceDisplayNameAttribute resourceDisplayName)
            {
