...
{
   /// <summary>
   /// "app-editor" tag helper
   /// </summary>
   [HtmlTargetElement("app-editor", Attributes = FOR_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
   public class AppEditorTagHelper : TagHelper
   {
      #region Constants
      ...
      public AppEditorTagHelper(IHtmlHelper htmlHelper)
      {
