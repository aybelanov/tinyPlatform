...
namespace Hub.Web.Framework.TagHelpers.Admin
{
   ...
   /// "app-card" tag helper
   /// </summary>
   [HtmlTargetElement("app-card", Attributes = NAME_ATTRIBUTE_NAME)]
   public class AppCardTagHelper : TagHelper
   {
      ...
      /// <summary>
      /// ContactName of the card
      /// </summary>
      [HtmlAttributeName(NAME_ATTRIBUTE_NAME)]
      public string Name { get; set; }

      /// <summary>
      /// ContactName of the hide attribute of the card
      /// </summary>
      ...
      public AppCardTagHelper(IHtmlHelper htmlHelper)
      {
