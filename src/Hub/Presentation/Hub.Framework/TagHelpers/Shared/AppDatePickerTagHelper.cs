...
{
   /// <summary>
   /// "app-date-picker" tag helper
   /// </summary>
   [HtmlTargetElement("app-date-picker", Attributes = DAY_NAME_ATTRIBUTE_NAME + "," + MONTH_NAME_ATTRIBUTE_NAME + "," + YEAR_NAME_ATTRIBUTE_NAME, TagStructure = TagStructure.WithoutEndTag)]
   public class AppDatePickerTagHelper : TagHelper
   {
      #region Constants
      ...
      public AppDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper, ILocalizationService localizationService)
      {
         Generator = generator;
