...
public abstract class BaseController : Controller
{
   ...
   /// <summary>
   /// Display "Edit" (manage) link (in public platform)
   /// </summary>
   /// <param name="editPageUrl">Edit page URL</param>
   protected virtual void DisplayEditLink(string editPageUrl)
   {
      var appHtmlHelper = EngineContext.Current.Resolve<IAppHtmlHelper>();

      appHtmlHelper.AddEditPageUrl(editPageUrl);
   }
   ...
   public virtual void SaveSelectedCardName(string cardName, bool persistForTheNextRequest = true)
   {
      ...
      //"GetSelectedCardName" method of \App.Web.Framework\Extensions\HtmlExtensions.cs
      if (string.IsNullOrEmpty(cardName))
         throw new ArgumentNullException(nameof(cardName));

      const string dataKey = "app.selected-card-name";
   ...
   {
      //keep this method synchronized with
      //"GetSelectedTabName" method of \App.Web.Framework\Extensions\HtmlExtensions.cs
      ...
      var dataKey = "app.selected-tab-name";
