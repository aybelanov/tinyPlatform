...
namespace Hub.Web.Framework.Models.DataTables
{
   ...
   /// </summary>
   public partial record DataTablesModel : BaseAppModel
   {
      #region Const

      /// <summary> Default page type </summary>
      ...
      /// <summary>
      /// Gets or sets a number of columns to generate in a footer. GetTable 0 to disable footer
      /// </summary>
