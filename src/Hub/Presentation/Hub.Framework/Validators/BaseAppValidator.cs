...
public abstract class BaseAppValidator<TModel> : AbstractValidator<TModel> where TModel : class
{
   #region Ctor
   ...
   protected virtual void SetStringPropertiesMaxLength(AppEntityDescriptor entityDescriptor, params string[] filterPropertyNames)
   {
   ...
   /// </summary>
   /// <param name="entityDescriptor">Entity descriptor</param>
   protected virtual void SetDecimalMaxValue(AppEntityDescriptor entityDescriptor)
   {
      if (entityDescriptor is null)
         return;
