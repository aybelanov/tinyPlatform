...
namespace Hub.Web.Framework.Security
{
   ...
   public static class FilePermissionHelper
   {
      ...
      [SupportedOSPlatform("windows")]
      private static bool CheckPermissionsInWindows(IAppFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
      {
      ...
      /// <param name="checkDelete">Check delete</param>
      /// <returns>Result</returns>
      public static bool CheckPermissions(this IAppFileProvider fileProvider, string path, bool checkRead, bool checkWrite, bool checkModify, bool checkDelete)
      {
         var result = false;
      ...
      /// </summary>
      /// <returns>Result</returns>
      public static IEnumerable<string> GetDirectoriesWrite(this IAppFileProvider fileProvider)
      {
      ...
      /// </summary>
      /// <returns>Result</returns>
      public static IEnumerable<string> GetFilesWrite(this IAppFileProvider fileProvider)
      {
         return new List<string>
            {
                fileProvider.MapPath(AppPluginDefaults.PluginsInfoFilePath),
                fileProvider.MapPath(AppDataSettingsDefaults.FilePath),
                fileProvider.MapPath(AppConfigurationDefaults.AppSettingsFilePath)
            };
      }
