...
public partial class AddressAttributeController : BaseAdminController
{
   ...
   public virtual async Task<IActionResult> List()
   {
      ...
      SaveSelectedCardName("usersettings-addressformfields");
   ...
   public virtual async Task<IActionResult> Create(AddressAttributeModel model, bool continueEditing)
   {
      ...
      if (ModelState.IsValid)
      {
         ...
         //activity log
         await _userActivityService.InsertActivityAsync("AddNewAddressAttribute",
   ...
   public virtual async Task<IActionResult> Edit(AddressAttributeModel model, bool continueEditing)
   {
      ...
      if (ModelState.IsValid)
      {
         ...
         //activity log
         await _userActivityService.InsertActivityAsync("EditAddressAttribute",
   ...
   public virtual async Task<IActionResult> Delete(long id)
   {
      ...
      //activity log
      await _userActivityService.InsertActivityAsync("DeleteAddressAttribute",
   ...
   public virtual async Task<IActionResult> ValueCreatePopup(AddressAttributeValueModel model)
   {
      ...
      if (ModelState.IsValid)
      {
         ...
         //activity log
         await _userActivityService.InsertActivityAsync("AddNewAddressAttributeValue",
   ...
   public virtual async Task<IActionResult> ValueEditPopup(AddressAttributeValueModel model)
   {
      ...
      if (ModelState.IsValid)
      {
         ...
         //activity log
         await _userActivityService.InsertActivityAsync("EditAddressAttributeValue",
   ...
   public virtual async Task<IActionResult> ValueDelete(long id)
   {
      ...
      //activity log
      await _userActivityService.InsertActivityAsync("DeleteAddressAttributeValue",
