...
public partial interface INewsModelFactory
{
   ...
   /// </returns>
   Task<NewsContentModel> PrepareNewsContentModelAsync(NewsContentModel newsContentModel, long? filterByNewsItemId);
   ...
   /// </returns>
   Task<NewsCommentListModel> PrepareNewsCommentListModelAsync(NewsCommentSearchModel searchModel, long? newsItemId);
