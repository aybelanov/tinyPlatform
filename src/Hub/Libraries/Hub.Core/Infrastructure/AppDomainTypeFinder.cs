...
public class AppDomainTypeFinder : ITypeFinder
{
   ...
   /// <summary>Gets or sets whether App should iterate assemblies in the app domain when loading App types. Loading patterns are applied when loading these assemblies.</summary>
   ...
   /// <remarks>If you change this so that App assemblies aren't investigated (e.g. by not including something like "^Hub|..." you may break core functionality.</remarks>
