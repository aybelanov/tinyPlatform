...
namespace Hub.Services.Common
{
   ...
   public partial interface IAddressAttributeService
   {
      ...
      /// </returns>
      Task<AddressAttribute> GetAddressAttributeByIdAsync(long addressAttributeId);
      ...
      /// </returns>
      Task<IList<AddressAttributeValue>> GetAddressAttributeValuesAsync(long addressAttributeId);
      ...
      /// </returns>
      Task<AddressAttributeValue> GetAddressAttributeValueByIdAsync(long addressAttributeValueId);
