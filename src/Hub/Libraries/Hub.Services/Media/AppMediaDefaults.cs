...
namespace Hub.Services.Media
{
   ...
   /// </summary>
   public static partial class AppMediaDefaults
   {
      /// <summary>
      ...
      /// {0} : thumb file name
      /// </remarks>
      public static CacheKey ThumbExistsCacheKey => new("App.azure.thumb.exists.{0}", ThumbsExistsPrefix);

      /// <summary>
      /// Gets a key pattern to clear cache
      /// </summary>
      public static string ThumbsExistsPrefix => "App.azure.thumb.exists.";
