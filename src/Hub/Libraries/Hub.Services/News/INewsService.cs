...
public partial interface INewsService
{
   ...
   /// </returns>
   Task<NewsItem> GetNewsByIdAsync(long newsId);
   ...
   /// </returns>
   Task<IPagedList<NewsItem>> GetAllNewsAsync(long languageId = 0, int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false, string title = null);
   ...
   /// </returns>
   Task<IList<NewsComment>> GetAllCommentsAsync(long userId = 0, long? newsItemId = null, bool? approved = null, DateTime? fromUtc = null,
      DateTime? toUtc = null, string commentText = null);
   ...
   /// </returns>
   Task<NewsComment> GetNewsCommentByIdAsync(long newsCommentId);
   ...
   /// </returns>
   Task<IList<NewsComment>> GetNewsCommentsByIdsAsync(long[] commentIds);
   ...
   /// </returns>
   Task<int> GetNewsCommentsCountAsync(NewsItem newsItem, bool? isApproved = null);
