...
namespace Hub.Services.News
{
   ...
   public partial class NewsService : INewsService
   {
      ...
      /// </returns>
      public virtual async Task<NewsItem> GetNewsByIdAsync(long newsId)
      {
      ...
      /// </returns>
      public virtual async Task<IPagedList<NewsItem>> GetAllNewsAsync(long languageId = 0, int pageIndex = 0, int pageSize = int.MaxValue,
      ...
      /// </returns>
      public virtual async Task<IList<NewsComment>> GetAllCommentsAsync(long userId = 0, long? newsItemId = null,
      ...
      /// </returns>
      public virtual async Task<NewsComment> GetNewsCommentByIdAsync(long newsCommentId)
      {
      ...
      /// </returns>
      public virtual async Task<IList<NewsComment>> GetNewsCommentsByIdsAsync(long[] commentIds)
      {
      ...
      /// </returns>
      public virtual async Task<int> GetNewsCommentsCountAsync(NewsItem newsItem, bool? isApproved = null)
      {
         ...
         var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(AppNewsDefaults.NewsCommentsNumberCacheKey, newsItem, isApproved);
