...
public partial class StateProvinceService : IStateProvinceService
{
   ...
   public virtual async Task<StateProvince> GetStateProvinceByAbbreviationAsync(string abbreviation, long? countryId = null)
   {
      ...
      var key = _staticCacheManager.PrepareKeyForDefaultCache(AppDirectoryDefaults.StateProvincesByAbbreviationCacheKey
   ...
   {
      var key = _staticCacheManager.PrepareKeyForDefaultCache(AppDirectoryDefaults.StateProvincesByCountryCacheKey, countryId, languageId, showHidden);
   ...
   public virtual async Task<IList<StateProvince>> GetStateProvincesAsync(bool showHidden = false)
   {
      ...
      var stateProvinces = await _staticCacheManager.GetAsync(_staticCacheManager.PrepareKeyForDefaultCache(AppDirectoryDefaults.StateProvincesAllCacheKey, showHidden), async () => await query.ToListAsync());
