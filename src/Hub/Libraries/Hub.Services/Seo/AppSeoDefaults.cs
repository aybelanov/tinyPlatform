...
namespace Hub.Services.Seo
{
   ...
   /// </summary>
   public static partial class AppSeoDefaults
   {
      /// <summary>
      ...
      public static List<string> ReservedUrlRecordSlugs => new()
        {
            //routes that redirected users to the specific actions
            "admin",
            "blog",
            "boards",
            "cart",
      ...
      /// {2} : language ID
      /// </remarks>
      public static CacheKey UrlRecordCacheKey => new("App.urlrecord.{0}-{1}-{2}");
      ...
      /// {0} : slug
      /// </remarks>
      public static CacheKey UrlRecordBySlugCacheKey => new("App.urlrecord.byslug.{0}");
