...
public partial class UrlRecordService : IUrlRecordService
{
   ...
   public virtual async Task<UrlRecord> GetBySlugAsync(string slug)
   {
      ...
      var key = _staticCacheManager.PrepareKeyForDefaultCache(AppSeoDefaults.UrlRecordBySlugCacheKey, slug);
   ...
   {
      //gradual loading
      var key = _staticCacheManager.PrepareKeyForDefaultCache(AppSeoDefaults.UrlRecordCacheKey, entityId, entityName, languageId);
