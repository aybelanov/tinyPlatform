...
public partial class HtmlFormatter : IHtmlFormatter
{
   ...
   /// <returns>Allowed html text</returns>
   ...
   /// <summary>
   /// Replace anchor text (remove a tag from the following URL <a href="http://example.com">FieName</a> and output only the string "FieName")
   /// </summary>
   /// <param name="text">Text</param>
   ...
   /// <param name="replaceAnchorTags">A value indicating whether to replace anchor text (remove a tag from the following URL <a href="http://example.com">FieName</a> and output only the string "FieName")</param>
   /// <returns>Formatted text</returns>
