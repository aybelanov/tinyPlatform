...
public partial class ThemeProvider : IThemeProvider
{
   ...
   /// <summary> Theme descriptor</summary>
   ...
   public ThemeProvider(IAppFileProvider fileProvider)
   {
   ...
   protected virtual void Initialize()
   {
      ...
      lock (_locker)
      {
         ...
         var themeDirectoryPath = _fileProvider.MapPath(AppPluginDefaults.ThemesPath);
         foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath,
             AppPluginDefaults.ThemeDescriptionFileName, false))
         {
