...
namespace Hub.Services.Plugins
{
   ...
   /// </summary>
   public static partial class AppPluginDefaults
   {
      /// <summary>
      ...
      /// {0} : user identifier
      /// </remarks>
      public static CacheKey AdminNavigationPluginsCacheKey => new("App.plugins.adminnavigation.{0}", AdminNavigationPluginsPrefix);

      /// <summary>
      /// Gets a key pattern to clear cache
      /// </summary>
      public static string AdminNavigationPluginsPrefix => "App.plugins.adminnavigation.";
   }
}