...
namespace Hub.Services.Plugins
{
   ...
   public partial class PluginDescriptor : PluginDescriptorBaseInfo, IDescriptor, IComparable<PluginDescriptor>
   {
      ...
      public PluginDescriptor()
      {
         ...
         LimitedToUserRoles = new List<long>();
      ...
      public static PluginDescriptor GetPluginDescriptorFromText(string text)
      {
         ...
         //application 2.00 didn't have 'SupportedVersions' parameter, so let's set it to "2.00"
      ...
      public virtual void Save()
      {
         ...
         var filePath = fileProvider.Combine(fileProvider.GetDirectoryName(OriginalAssemblyFile), AppPluginDefaults.DescriptionFileName);
      ...
      /// <summary>
      /// Gets or sets the supported versions of the application
      /// </summary>
      ...
      public virtual IList<long> LimitedToUserRoles { get; set; }
