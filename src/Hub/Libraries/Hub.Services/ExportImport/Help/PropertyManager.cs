...
public class PropertyManager<T>
{
   ...
   public PropertyManager(IEnumerable<PropertyByName<T>> properties, CommonSettings catalogSettings)
   {
      _properties = new Dictionary<string, PropertyByName<T>>();
      _commonSettings = catalogSettings;
   ...
   /// <summary>
   /// GetTable caption style to excel cell
   /// </summary>
   ...
   /// </summary>
   public bool UseDropdownLists => _commonSettings.ExportImportRelatedEntitiesByName;
}
