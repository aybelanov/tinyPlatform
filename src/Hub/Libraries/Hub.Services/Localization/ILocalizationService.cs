...
public partial interface ILocalizationService
{
   ...
   /// The task result contains the locale string resource
   /// </returns>
   Task<LocaleStringResource> GetLocaleStringResourceByNameAsync(string resourceName, long languageId, bool logIfNotFound = true);
   ...
   /// The task result contains a string representing the requested resource string.
   /// </returns>
   Task<string> GetResourceAsync(string resourceKey, long languageId, bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false);
